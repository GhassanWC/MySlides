...
import { generateSlidesPayload } from '../services/openai.js';
...
router.post('/generate', requireAuth, async (req: Request, res: Response) => {
  try {
    ...
    const payload = await generateSlidesPayload(text);
    return res.json({ slides: payload.slides, theme: payload.theme });
  } catch (err) {
